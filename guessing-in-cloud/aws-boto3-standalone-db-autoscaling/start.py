...
userDataWebServer = ('#!/bin/bash\n'
                     '# essential tools\n'
                     'yum install -y joe htop git unzip\n'
                     '\n'
                     '# Install AWS CLI\n'
                     ...
                     'wget https://raw.githubusercontent.com/megaz90/cloud-comp25/feature/dynamodb/guessing-in-cloud/web-content/vendor.zip\n'
                     'wget https://raw.githubusercontent.com/megaz90/cloud-comp25/feature/dynamodb/guessing-in-cloud/web-content/htaccess_file\n'
                     'sudo mv htaccess_file .htaccess\n'
                     '\n'
                     '# Unzip the file'
                     ...
                     'sleep 10'
                     '# Update Apache configuration to use /var/www/html/src as DocumentRoot'
                     'sudo sed -i "s|DocumentRoot \"/var/www/html\"|DocumentRoot \"/var/www/html/src\"|" /etc/httpd/conf/httpd.conf'
                     '\n'
                     ...
                     'sudo /usr/local/bin/composer install --working-dir=/var/www/html'
                     'sudo service httpd restart'
                     )
