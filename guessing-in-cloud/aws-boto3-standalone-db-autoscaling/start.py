...
userDataWebServer = ('#!/bin/bash\n'
                     ...
                     '\n'
                     'cd /var/www/html\n'
                     'wget https://raw.githubusercontent.com/megaz90/cloud-comp25/addDynamoDB/guessing-in-cloud/web-content/index.php\n'
                     'wget https://raw.githubusercontent.com/megaz90/cloud-comp25/addDynamoDB/guessing-in-cloud/web-content/cloud.php\n'
                     'wget https://raw.githubusercontent.com/megaz90/cloud-comp25/addDynamoDB/guessing-in-cloud/web-content/config.php\n'
                     '\n'
